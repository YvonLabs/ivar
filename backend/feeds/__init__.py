...
from .eu_feeds import (
    CertEuConnector, CertEuTiConnector,
...
# Fallback connectors used when DB is unavailable
DEFAULT_CONNECTORS = [
...
# All available built-in connectors
ALL_CONNECTORS = list(BUILT_IN_CONNECTORS.values())
